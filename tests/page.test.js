...
test("renderHomePage includes a paginated daily log, range controls, and an SSR trend chart", async () => {
  ...
  assert.match(html, /rel="icon" type="image\/png" sizes="256x256" href="\/shotlog_favicon\.png\?v=3"/);
  assert.match(html, /rel="shortcut icon" type="image\/x-icon" href="\/favicon\.ico\?v=3"/);
